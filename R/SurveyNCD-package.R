...
#'
#' Provides tools to clean, model, and interpret self-reported NCD indicators
#' from complex surveys (WHO STEPS, DHS, MICS, and similar designs), where
#' valid estimation requires handling weights, strata, and clusters.
#'
#' @details
